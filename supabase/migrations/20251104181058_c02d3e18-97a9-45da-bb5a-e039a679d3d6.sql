-- 1. Adicionar colunas de qualificação de leads
ALTER TABLE leads 
...
-- 3. Trigger para calcular score automaticamente
...
DROP TRIGGER IF EXISTS trigger_notify_n8n_new_lead ON leads;
CREATE TRIGGER trigger_notify_n8n_new_lead
  AFTER INSERT ON leads
  FOR EACH ROW
  EXECUTE FUNCTION notify_n8n_new_lead();

-- 5. Habilitar realtime para leads (notificações instantâneas no admin)
